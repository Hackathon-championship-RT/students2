...
const generateCards = (layerIndex, gridSize) => {
  ...
  const images = require.context('./random', false, /\.(jpg|jpeg|png)$/);
...
const MahjongRandomCarsEasy2 = () => {
  ...
  const checkLevelCompletion = useCallback(() => {
    ...
    if (allMatched) {
      ...
      navigate('/mahjong-randomCars-easy-3');
    }
...
export default MahjongRandomCarsEasy2;
